...
- OLLAMA_BASE_URL=http://ollama-node.${TAILNET_NAME}.ts.net:11434       - API_SERVER_KEY=${API_SERVER_KEY}
- HERMES_DASHBOARD=1
...
git clone [https://github.com/YOUR_USERNAME/sovereign-agent-infrastructure.git](https://www.google.com/search?q=https://github.com/YOUR_USERNAME/sovereign-agent-infrastructure.git)
